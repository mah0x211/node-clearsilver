...
var pkg = {
    ...
    binding = require( __dirname + '/../build/default/clearsilver'),
    CACHE = {};
...
function ClearSilver()
{
    ...
    // console.log( 'about binding:' );
    // console.log( require('util').inspect( binding, true, 10 ) );
    this.cs = new binding.ClearSilver();
